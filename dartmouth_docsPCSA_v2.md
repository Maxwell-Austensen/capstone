...
dart_nyc <- mutate(dart_nyc, acscd_rt = if_else(hospdenom != 0, (medicare_acscd / hospdenom), NA_real_),
                   pcpvt_rt = if_else(pcpdenom != 0, (pcpvt/ pcpdenom), NA_real_),
