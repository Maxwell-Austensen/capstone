...
tract_pcsa_xwalk <- read_csv("C:/Users/alg638/Documents/capstone/tract_pcsa_xwalk.csv", col_types = "ccc")
...
ncdb_adj <- ncdb_raw %>% 
  ...
  select(year, geo2010, numhhs, rntocc, aggrent, avhhin_n, fem4, fem9, fem14, 
         fem17_a, fem24, fem29,  fem34, fem44, fem54, fem64, fem74, fem75, 
         men4, men9, men14, men17_a, men24, men29, men34, men44, men54, men64, 
         men74, men75, trctpop, educ16, educ12, educpp, povrat_n, povrat_d, numhhs, 
...
pcsa_wide <- ncdb_adj %>% 
  ...
  summarise_at(vars(avhhin_n_adj, numhhs, aggrent_adj, rntocc, trctpop, educ16, educ12, educpp, povrat_n, povrat_d, numhhs, 
        shrhsp_n, shrnhb_n, shrnhw_n, shrnha_n, shr_d, age_lt5, age_5_17, age_20_34, age_35_54, age_55p), sum) %>% 
  ungroup %>% 
...
write_csv(tract_output, "C:/Users/alg638/Documents/capstone/tract_gent.csv")
write_csv(pcsa_output, "C:/Users/alg638/Documents/capstone/pcsa_gent.csv")
