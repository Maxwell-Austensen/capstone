...
nyc99 <-
  mutate(nyc99, physician_rat = if_else(physicians !=0, (totpop/ physicians), NA_real_),
         pa_rat = if_else(pa_tot !=0, (totpop/pa_tot), NA_real_),
         allpcp_rat = if_else(allpcp !=0, (totpop / allpcp), NA_real_),
         specs_rat = if_else(specs != 0, (totpop / specs), NA_real_),
         obstets_rat = if_else(obstets !=0, (fem15_44 / obstets), NA_real_),
         img_rat = if_else(allimg != 0, (totpop / allimg), NA_real_))
...
nyc99 <- 
  mutate(nyc99, pcp_rt = if_else(pcpdenom != 0, (pcpvt / pcpdenom), NA_real_),
         ed_rt = if_else(eddenom != 0, (edvt /eddenom), NA_real_))
