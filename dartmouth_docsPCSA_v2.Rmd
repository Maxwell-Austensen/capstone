...
```{r}
## COMBINE DATASETS
# need to add year and create new sets with same number of vars for analysis before using rbind
...
#             pcpvt_rt = sum(pcpvt[!is.na(pcpvt_rt)], na.rm = T) / sum(pcpdenom[!is.na(pcpvt_rt)], na.rm=T) * 100, 
